...
function undockedLayout()
  ...
  return {
    ...
    { "Cursor", nil, laptopScreen, regions.full, nil, nil },
    ...
    { "Ghostty", nil, laptopScreen, regions.full, nil, nil },
...
function dockedWithDualVerticalUlrawideLayout()
  ...
  return {
    ...
    { "Cursor", nil, externalPrimaryScreen, regions.focalPrimary, nil, nil },
      ...
      { "Ghostty", nil, externalPrimaryScreen, regions.peripheralPrimary, nil, nil },
